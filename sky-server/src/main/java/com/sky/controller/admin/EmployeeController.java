...
public class EmployeeController {
     ...
     * @return
     */
    @Operation(summary = "员工登录", description = "员工登录系统")
    @PostMapping("/login")
     ...
     * @return
     */
    @Operation(summary = "员工退出", description = "员工登出系统")
    @PostMapping("/logout")
...
//    非查询类可以不加泛型
     ...
     */
    @GetMapping("/{id}")
    @Operation(summary = "根据id查询员工",description = "员工状态修改")
     ...
     */
    @PutMapping
    @Operation(summary = "提交修改员工属性",description = "提交修改员工属性")
